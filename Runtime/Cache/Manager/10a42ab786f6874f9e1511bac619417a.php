                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    ...
                                    <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($v["msg_type_name"]); ?></td>
                                            <td><?php echo ($v["msg_time"]); ?></td>
                                            <td>
                                                <span class="label label-primary arrow-in"><?php echo ($v["is_replay"]); ?></span>

                                            </td>
                                            <td>
                                                <a href="<?php echo U('Feedback/info',array('id'=>$v['msg_id']));?>" class="fa fa-hdd-o tip " data-original-title="查看详情" > </a>
