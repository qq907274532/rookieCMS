                                ...
                                <div class="clearfix" style="margin-bottom:-10px;">
                                    <form action="" method="get" class="form-horizontal">
                                            ...
                                            <div class="form-group col-sm-3" >
                                             ...
                                             <a href="<?php echo U('Article/add');?>" class="btn btn-primary pull-right">添加文章 <i class="fa fa-arrow-right"></i></a>
                                    ...
                                    <table class="table table-striped">
                                       ...
                                       <tr>         
                                        ...
                                        <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a href="<?php echo U('Article/edit',array('id'=>$v['article_id']));?>" class="fa fa-pencil tip"data-original-title="修改"></a>
