                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="box border primary">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select   class="form-control"  name="cat_id" id="cate">
                                                <option value="0">请选择分类</option>
                                                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" ><?php echo ($v["cat_name"]); ?></option>
                                                     <?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;└-<?php echo ($vo["cat_name"]); ?></option>
                                                  
                                                    <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└-<?php echo ($val["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="title" placeholder="文章名称" class="form-control" name="title"  value="" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-xs-12 col-sm-4">
                                             <textarea rows="6" cols="5" id="description" name="description" class="autosize form-control textarea-transition" placeholder="描述" style="overflow: hidden; word-wrap: break-word; resize: horizontal; "></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="form-field-2" placeholder="排序" class="form-control"  name="sort" value="50" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7 col-xs-4">
                                            <textarea id="desc" name="content" style="width:700px;height:300px;"></textarea>
