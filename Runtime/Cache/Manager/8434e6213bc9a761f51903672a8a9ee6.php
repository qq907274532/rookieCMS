                            ...
                            <div class="box-body big">
                                <form class="form-horizontal" role="form" id="myForm">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="username" id="username" value="<?php echo ($info["username"]); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="amount" id="amount"
                                                    placeholder="金额" value="<?php echo ($info["amount"]); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="payMent" id="payMent" disabled="true">
                                                <?php if(is_array($payMent)): $i = 0; $__LIST__ = $payMent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["pay_id"]); ?>"  <?php if($info["payment_id"] == $v.pay_id): ?>selected="selected"<?php endif; ?> ><?php echo ($v["pay_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?php if(is_array($pay_type)): $i = 0; $__LIST__ = $pay_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><label class="radio-inline"> <input type="radio" class="process_type" name="process_type"  value="<?php echo ($key); ?>" <?php if($info["process_type"] == $key): ?>checked="checked"<?php endif; ?> disabled> <?php echo ($v); ?> </label><?php endforeach; endif; else: echo "" ;endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea class="form-control" rows="5" name="admin_note" id="admin_note" placeholder="管理员的备注"><?php echo ($info["admin_note"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea class="form-control" rows="5" name="user_note" id="user_note" placeholder="用户备注"><?php echo ($info["user_note"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">到款状态：</label>
                                        <div class="col-sm-4">
                                            <?php if(is_array($pay_status)): $i = 0; $__LIST__ = $pay_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><label class="radio-inline"> <input type="radio" class="is_paid" name="is_paid"  value="<?php echo ($key); ?>" <?php if($info["is_paid"] == $key): ?>checked="checked"<?php endif; ?> disabled> <?php echo ($v); ?> </label><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <script type="text/javascript">
                $(function(){
                    $("#submit").click(function(){
                        ...
                        $.post("<?php echo U('RechargeCash/edit');?>",{
