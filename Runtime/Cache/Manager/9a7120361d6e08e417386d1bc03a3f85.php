                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="parent_id" id="role">
                                                ...
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["cat_name"]); ?></option>
                                                    <?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>">&nbsp;└-<?php echo ($vo["cat_name"]); ?>
            ...
            <script type="text/javascript">
                $(function(){
                    $("#submit").click(function(){
                        ...
                        $.post("<?php echo U('Cate/add');?>",$("#myForm").serialize(),function( response ){
