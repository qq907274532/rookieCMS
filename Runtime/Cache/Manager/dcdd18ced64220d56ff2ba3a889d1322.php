                                    ...
                                    <div  class="col-sm-12">
                                        ...
                                        <div class="form-group col-sm-3" >
                                            <label class=" control-label col-sm-4" >收货人：</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control col-sm-12"  placeholder="收货人" id="username" name="username"  value="<?php echo ($_GET['username']); ?>">
                                                </div>
                                        ...
                                        <div class="form-group col-sm-3" >
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="order_status" id="order_status">
                                                    ...
                                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($_GET['order_status']== $k): ?>selected=selected<?php endif; ?> ><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    ...
                                    <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <?php if($v["status"] != Common\Model\OrderInfoModel::ORDER_TRANSACTION_CANCELLATION): ?><span class="label label-primary arrow-in"><?php echo ($v["orderStatusName"]); ?></span>
                                                    <?php else: ?>
