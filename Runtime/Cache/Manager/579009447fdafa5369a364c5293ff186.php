                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>申请提现</li>
                                <a href="<?php echo U('RechargeCash/add');?>" class="btn btn-primary pull-right ">增加申请 <i class="fa fa-arrow-right"></i></a>
                            </ul>
                            <div class="clearfix">
                                        ...
                                        <div class="form-group col-sm-2" >
                                            <div class="col-sm-12">
                                                <select class="form-control" name="process_type" id="process_type">
                                                    ...
                                                    <?php if(is_array($pay_type)): $i = 0; $__LIST__ = $pay_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($_GET['process_type']== $key ): ?>selected="selected"<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-2" >
                                            <div class="col-sm-12">
                                                <select class="form-control" name="payMent" id="payMent">
                                                    ...
                                                    <?php if(is_array($payMent)): $i = 0; $__LIST__ = $payMent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["pay_id"]); ?>" <?php if($_GET['payMent']== $v["pay_id"] ): ?>selected="selected"<?php endif; ?>><?php echo ($v["pay_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-2" >
                                            <div class="col-sm-12">
                                                <select class="form-control" name="is_paid" id="is_paid">
                                                    ...
                                                    <?php if(is_array($pay_status)): $i = 0; $__LIST__ = $pay_status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($_GET['is_paid']== $key ): ?>selected="selected"<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="box-body">
                                <table class="table table-striped">
                                    ...
                                    <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($v["process_type_name"]); ?></td>

                                            <td><?php echo ($v["amount"]); ?></td>
                                            <td><?php echo ($v["payment"]); ?></td>
                                            <td>
                                                <?php if($v["is_paid"] == Common\Model\UserAccountModel::PAY_STATUS_SUCCESS): ?><span class="label label-primary arrow-in"><?php echo ($v["is_paid_name"]); ?></span>
                                                    <?php else: ?>
                                                    <span class="label  label-danger arrow-out "><?php echo ($v["is_paid_name"]); ?></span><?php endif; ?>
                                            </td>

                                            <td><?php echo ($v["admin_user"]); ?></td>
                                            <td>
                                                <?php if($v["is_paid"] == Common\Model\UserAccountModel::PAY_STATUS_SUCCESS ): ?><a href="<?php echo U('RechargeCash/edit',array('id'=>$v['id']));?>" class="fa fa-pencil tip" data-original-title="修改"></a>
                                                <?php else: ?>
                                                    <a href="<?php echo U('RechargeCash/check',array('id'=>$v['id']));?>" class="fa fa-sun-o tip" data-original-title="审核"></a>
                                                    <a href="javascript:;" class="fa fa-trash-o tip checkStatus" data-original-title="删除"> </a><?php endif; ?>
