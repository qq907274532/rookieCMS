                    ...
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>修改分类</li>
                                <a href="<?php echo U('Cate/index');?>" class="btn btn-primary pull-right "><i class="fa fa-arrow-left"></i>返回 </a>
                            </ul>
                            <div class="clearfix">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="pid" id="pid">
                                                <option value="0"  <?php if(0 == $info['parent_id']): ?>selected="selected"<?php endif; ?> >请选择父级</option>
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"  <?php if($v['id'] == $info['parent_id']): ?>selected="selected"<?php endif; ?> ><?php echo ($v["cat_name"]); ?></option>
                                                    <?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $info['parent_id']): ?>selected="selected"<?php endif; ?>>&nbsp;└-<?php echo ($vo["cat_name"]); ?></option>
                                                        <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val['id'] == $info['parent_id']): ?>selected="selected"<?php endif; ?>> &nbsp; &nbsp; &nbsp; &nbsp;└─<?php echo ($val["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="cat_type" id="cat_type">
                                                <?php if(is_array($cateType)): $k = 0; $__LIST__ = $cateType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>"><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="sort_order" id="sort_order"
                                                    placeholder="排序" value="<?php echo ($info["sort_order"]); ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-offset-4 col-sm-6">
                                            <input type="hidden" name="id" class="cateId" value="<?php echo ($info["id"]); ?>">
            ...
            <script type="text/javascript">
                $(function(){
                    $("#submit").click(function(){
                        ...
                        $.post("<?php echo U('Cate/edit');?>",{'cat_name':cat_name,'sort_order':sort_order,'parent_id':pid,'id':cateId,'cat_type':cat_type},function( response ){
                ...
                function load(){
                    window.location.href="<?php echo U('Cate/index');?>";
                }
            </script>